...
#
# Script generated by Vivado on Fri Apr 18 09:43:11 +0800 2025
...
#
# Usage        : rom0.sh
#                rom0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rom0.sh [-reset_run]
#                rom0.sh [-reset_log]
#                rom0.sh [-help]
#
...
export RDI_DATADIR="D:/coding/Xilinx/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "rom0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rom0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rom0 xil_defaultlib.rom0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rom0 -key {Behavioral:sim_1:Functional:rom0} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/coding/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rom0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rom0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rom0.sh [-help]\n\
Usage: rom0.sh [-step]\n\
Usage: rom0.sh [-lib_map_path]\n\
Usage: rom0.sh [-reset_run]\n\
Usage: rom0.sh [-reset_log]\n\
Usage: rom0.sh [-keep_index]\n\
Usage: rom0.sh [-noclean_files]\n\n\
