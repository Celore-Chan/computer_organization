...
module design_1
  ...
  design_1_adpt_out_0_0 adpt_out_0
       (.clk_100M(cg_fpga_0_clk_100M),
        .digit0(ram_dp1_1Kx4_0_q),
        .digit1(ram_dp1_1Kx4_1_q),
  ...
  design_1_cg_fpga_0_0 cg_fpga_0
       (.audio({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        ...
        .vid_vblank(1'b0),
        .vid_vsync(1'b0));
  design_1_ram_dp1_1Kx4_0_2 ram_dp1_1Kx4_0
       (.address(adpt_in_0_addr_9_0),
        .data(adpt_in_0_data0),
        .inclock(adpt_in_0_clk),
        .q(ram_dp1_1Kx4_0_q),
        .wren(adpt_in_0_wren));
  design_1_ram_dp1_1Kx4_1_2 ram_dp1_1Kx4_1
       (.address(adpt_in_0_addr_9_0),
        .data(adpt_in_0_data1),
        .inclock(adpt_in_0_clk),
        .q(ram_dp1_1Kx4_1_q),
        .wren(adpt_in_0_wren));
endmodule
