...
#
# Script generated by Vivado on Thu May 08 12:38:35 +0800 2025
...
#
# Usage        : ram1.sh
#                ram1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram1.sh [-reset_run]
#                ram1.sh [-reset_log]
#                ram1.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L xilinx_vip"

# script info
echo -e "ram1.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ram1 xil_defaultlib.ram1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ram1 -key {Behavioral:sim_1:Functional:ram1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ram1.wdb xsim.dir libdpi.so)
...
Usage: ram1.sh [-reset_log]\n\
Usage: ram1.sh [-keep_index]\n\
