...
#
# Script generated by Vivado on Mon May 12 17:04:29 +0800 2025
...
#
# Usage        : rom1.sh
#                rom1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rom1.sh [-reset_run]
#                rom1.sh [-reset_log]
#                rom1.sh [-help]
#
...
# script info
echo -e "rom1.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rom1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rom1 xil_defaultlib.rom1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rom1 -key {Behavioral:sim_1:Functional:rom1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rom1.wdb xsim.dir libdpi.so)
...
Usage: rom1.sh [-reset_log]\n\
Usage: rom1.sh [-keep_index]\n\
