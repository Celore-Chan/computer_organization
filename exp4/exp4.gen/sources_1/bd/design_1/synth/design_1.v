...
module design_1
  ...
  design_1_cg_fpga_0_0 cg_fpga_0
       (.DDR_addr(DDR_0_addr),
        ...
        .vid_vblank(1'b0),
        .vid_vsync(1'b0));
  design_1_or3_0_0 or3_0
       (.a(and2_10_y),
        .b(and2_11_y),
        .c(and2_7_y),
        .y(or3_0_y));
  design_1_or3_1_0 or3_1
       (.a(and2_8_y),
        .b(and2_0_y),
        .c(and2_9_y),
        .y(or3_1_y));
  design_1_or3_2_0 or3_2
       (.a(and2_6_y),
        .b(and2_5_y),
        .c(and2_4_y),
        .y(or3_2_y));
  design_1_or3_3_0 or3_3
       (.a(and2_3_y),
        .b(and2_2_y),
        .c(and2_1_y),
        .y(or3_3_y));
