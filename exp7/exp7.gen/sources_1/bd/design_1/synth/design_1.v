...
module design_1
  ...
  design_1_adpt_out_0_1 adpt_out_0
       (.T1(dff_0_q),
        ...
        .T4(dff_1_q),
        .led(adpt_out_0_led));
  design_1_cg_fpga_0_1 cg_fpga_0
       (.audio({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        ...
        .vid_vblank(1'b0),
        .vid_vsync(1'b0));
  design_1_dff_0_2 dff_0
       (.clk(or2_0_y),
        .clrn(adpt_in_0_rst),
        .d(nor4_0_y),
        .prn(xlconstant_0_dout),
        .q(dff_0_q));
  design_1_dff_1_2 dff_1
       (.clk(or2_0_y),
        .clrn(adpt_in_0_rst),
        .d(dff_3_q),
        .prn(xlconstant_0_dout),
        .q(dff_1_q));
  design_1_dff_2_2 dff_2
       (.clk(or2_0_y),
        .clrn(adpt_in_0_rst),
        .d(dff_0_q),
        .prn(xlconstant_0_dout),
        .q(dff_2_q));
  design_1_dff_3_2 dff_3
       (.clk(or2_0_y),
        .clrn(adpt_in_0_rst),
        .d(dff_2_q),
        .prn(xlconstant_0_dout),
  ...
  design_1_dff_4_0 dff_4
       (.clk(or2_0_y),
        ...
        .prn(xlconstant_0_dout),
        .q(dff_4_q));
  design_1_nor4_0_0 nor4_0
       (.a(dff_0_q),
        .b(dff_2_q),
        .c(dff_3_q),
        .d(dff_1_q),
        .y(nor4_0_y));
  design_1_or2_0_0 or2_0
       (.a(dff_4_q),
        .b(adpt_in_0_clk_div),
        .y(or2_0_y));
